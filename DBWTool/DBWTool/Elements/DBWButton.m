...
NSString const *UIButton_indexPathValueKey = @"UIButton_indexPathValueKey";
...
-(NSIndexPath *)indexPath{
    ...
    return objc_getAssociatedObject(self, &UIButton_indexPathValueKey);
}
-(void)setIndexPath:(NSIndexPath *)indexPath{
    objc_setAssociatedObject(self, &UIButton_indexPathValueKey, indexPath, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
-(UILabel*) badge {
